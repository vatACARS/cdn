                ...
                <div className="max-w-6xl mx-auto flex flex-col gap-8">
                        ...
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
                            <div className="flex items-center gap-3">
                                <Image
                                    ...
                                    className="relative"
                                />
                                <span className="text-zinc-100 font-medium">vatACARS CDN</span>
                            </div>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6 border-t border-zinc-800/50">
                        ...
                        <div className="flex gap-6 text-sm">
                            <Link href="https://vatacars.com/legal/attribution">
                            ...
                            <Link href="https://vatacars.com/legal/terms">
                            ...
                            <Link href="https://vatacars.com/legal/privacy">
